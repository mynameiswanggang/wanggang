...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <!-- Events calendar -->
        <div class="widget">
            <div class="title"><img src="<?php echo (ADMIN_IMG_URL); ?>icons/dark/monthCalendar.png" alt="" class="titleIcon" /><h6>Events</h6></div>
    ...
    <!-- Footer line -->
    <div id="footer">
        <div class="wrapper">As usually all rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="ģ��֮��">ģ��֮��</a> - Collect from <a href="http://www.cssmoban.com/" title="��ҳģ��" target="_blank">��ҳģ��</a></div>
    </div>
