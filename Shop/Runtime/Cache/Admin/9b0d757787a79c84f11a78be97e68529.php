...
<div id="userInfoList" class="wrapper">
		...
		<table cellpadding="0" cellspacing="0" border="0"
			...
			<tbody>
		 		<tr v-for="user in userList">
					...
					<td><a v-bind:href="#">修改</a> | <a v-bind:href="#">删除</a></td>
				</tr> 
			</tbody>
		</table>
	</div>
...
<script>
  		//$(function(){
  			var userTable = $('.dTable').dataTable({
  				"bJQueryUI": true,
  				"sPaginationType": "full_numbers",
  		        "bProcessing": true,
  		        "bServerSide": true,
  		        "sAjaxSource": "<?php echo U('Admin/user/user_list');?>" 				
  			});
  			console.log(userTable.data());
  			var users = userTable.data();
  		//});
  //$(function(){ 
